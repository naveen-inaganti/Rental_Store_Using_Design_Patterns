...
public class StrategyForRentMovieObject implements StrategyForObjectsRental {
	
	
	@Override
	public double getRentAmount(int _daysRented) {
		
		return _daysRented*2.0;
	...
	public double getFRPointsRental(int _daysRented, String rentObjectSubId) {
		...
		{
			return _daysRented*2.0*2;
		}
		else if(rentObjectSubId.equals(ListObject.REGULAR)) {
			return _daysRented*2.0*1;
		}
		else {  
			return _daysRented*2.0*1.5;
		}
	}
}
